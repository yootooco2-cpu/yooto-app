...
**Anti-pattern — L'anneau fourre-tout qui fabrique une preuve.** Le SPT classait « éloigné » tout NAF absent de ses listes cœur/compatible, et cet anneau produisait une *preuve* de non-pertinence → rejet. 47.23Z (poissonneries) en a été la victime mesurée : 56 faux rejets à Sète, la ville de la poissonnerie. *Règle : une exclusion n'existe que par **preuve positive** — une liste explicite, sémantiquement justifiée (nomenclature INSEE, ou décision métier documentée comme 56.10C restauration rapide). L'absence d'une valeur dans une énumération n'est jamais une preuve (Loi 3) ; le défaut d'un classement est toujours « inconnu / neutre », jamais « exclu ». Validation obligatoire : rejouer les candidats concernés et vérifier que 100 % des transitions appartiennent à la classe corrigée.*

**Pattern — Le score de complétude ordonne, il ne note jamais.** Le score de présentation
n'est JAMAIS une note de qualité : un commerce à 4/12 peut être excellent ; une fiche à
12/12 est simplement mieux renseignée. Il ne publie, ne masque, n'exclut jamais — il
ordonne l'affichage, rien d'autre. *Corollaire d'affichage : un chiffre présenté nu EST
une note, quelle que soit la doctrine — côté commerçant on n'affiche donc jamais une
fraction ni un pourcentage, uniquement une LISTE D'ACTIONS de progression (« ajoutez vos
horaires »). Architecture : le score est DÉRIVÉ (jamais saisi), RECALCULÉ automatiquement
et MATÉRIALISÉ (colonne générée) — un cache auto-invalidé qui ne peut pas se
désynchroniser du contenu (Loi 7).*
