...
const BIENETRE_PICTOS: Record<string, ImageSourcePropType> = {
  ...
  osteopathe: require('@/assets/images/cryptograms/bienetre/osteopathe.png'),
  chiropracteur: require('@/assets/images/cryptograms/bienetre/chiropracteur.png'),
  kinesitherapeute: require('@/assets/images/cryptograms/bienetre/kinesitherapeute.png'),
